...
import okhttp3.*
import com.example.testhackathon.databinding.ActivitySignInBinding
...
//            .add("Authorization", "Bearer <your_token>")
            ...
            val request =
                Request.Builder().url("${HttpClient.baseurl}/api/accounts/login/").post(requestBody)
            ...
            HttpClient.client.newCall(request).enqueue(object : Callback {
                override fun onResponse(call: Call, response: Response) {
                    ...
                    if (success) {
                        ...
                        val intent = Intent(this@SignInActivity, MyHabits::class.java)
